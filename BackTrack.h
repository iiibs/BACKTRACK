...
template <class T, class I, class V,class F,class P>
BackTrack<T,I,V,F,P>::BackTrack(const T& first, const T& last) 
   : left_child (first), right_child (last)
{
}

template <class T, class I, class V,class F,class P>
bool BackTrack<T,I,V,F,P>::VisitNewNode(const I& begin, I& end)
{
   // ALGORITHM:
   //
...
template <class T, class I, class V,class F,class P> 
bool BackTrack<T,I,V,F,P>::FindValidSibling
...
template <class T, class I, class V,class F,class P>
inline void BackTrack<T,I,V,F,P>::CreateLeftLeaf (I& end)
{
   *(end++) = left_child;
}

template <class T, class I, class V,class F,class P>
bool BackTrack<T,I,V,F,P>::operator()
(const I& begin, I end, bool& first)
{
 //const int size = end - begin;
 const __int64 size=end-begin;
 #ifdef DEBUG2
 cout << "number of decisions required to solve the problem: " << size << endl;
 #endif
